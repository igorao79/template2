...
const animals = [
  {
    ...
    name: 'Лев',
    icon: '🦁',
    sound: getAssetPath('/sounds/lion.mp3'),
  ...
  },
  {
    ...
    name: 'Слон',
    icon: '🐘',
    sound: getAssetPath('/sounds/elephant.mp3'),
  ...
  },
  {
    ...
    name: 'Обезьяна',
    icon: '🐒',
    sound: getAssetPath('/sounds/monkey.mp3'),
  ...
  },
  {
    ...
    name: 'Тигр',
    icon: '🐯',
    sound: getAssetPath('/sounds/tiger.mp3'),
  ...
  },
  {
    ...
    name: 'Жираф',
    icon: '🦒',
    sound: getAssetPath('/sounds/giraffe.mp3'),
  ...
  },
  {
    ...
    name: 'Волк',
    icon: '🐺',
    sound: getAssetPath('/sounds/wolf.mp3'),
